...
class Wpresidence_Contact_Form_Builder extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control(
            ...
            'label' => esc_html__('Form Label Spacing', 'residence-elementor'),
            'type' => Controls_Manager::SLIDER,
            'default' => [
                'size' => 0,
            ],
    ...
    protected function render() {
        ...
        <form class="elementor-form wpresidence_elementor_form"  id="wpresidence-elementor-form-<?php echo $this->get_id(); ?>" method="post" <?php echo $this->get_render_attribute_string('form'); ?>>
