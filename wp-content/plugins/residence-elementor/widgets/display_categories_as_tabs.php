...
class Wpresidence_Display_Categories_As_Tabs extends Widget_Base {
    ...
    public function get_title() {
        return __('WpResidence Display Categories As Tabs', 'residence-elementor');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
                'show_zero_terms', [
            'label' => __('Hide Terms with no listings', 'residence-elementor'),
    ...
    $this->add_control(
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .wpestate_categories_as_tabs_item.active i' => 'color: {{VALUE}};',
                '{{WRAPPER}} .wpestate_categories_as_tabs_item.active svg' => 'fill: {{VALUE}}!important;color: {{VALUE}}!important;',
            ],
