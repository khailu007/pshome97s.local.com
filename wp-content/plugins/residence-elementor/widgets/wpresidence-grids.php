...
class Wpresidence_Grids extends Widget_Base {
  ...
  public function get_categories() {
	...
	public function get_title() {
		return __( 'WpResidence Grids', 'residence-elementor' );
	}
        ...
        protected function register_controls() {
					...
					$this->add_control(
				         ...
				         $this->add_control(
				             'grid_taxonomy',
				             [
				                 'label'     => esc_html__( 'Pick Categories','residence-elementor'  ),
				                 'type'      => Controls_Manager::SELECT,
				                 'options'   => [
			         ...
			         $this->add_control(
			             ...
			             [
                            ...
                            $this->add_control(
                                           ...
                                           [
                                                           'label'     => esc_html__( 'Listings Background Color - Design Type2', 'residence-elementor' ),
                                                           'type'      => Controls_Manager::COLOR,
                                                           'default'   => '',
                                                           'selectors' => [
