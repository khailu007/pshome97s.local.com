...
class Wpresidence_Property_Page_Similar_Section extends Widget_Base {
    ...
    public function get_title() {
        return __('Property Page Similar Listings Section', 'residence-elementor');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
                'unit_type', [
            'label' => __('Card unit ?', 'residence-elementor'),
        ...
        $this->add_responsive_control(
            ...
            'size_units' => ['px', '%', 'em'],
            'selectors' => [
                '{{WRAPPER}} .mylistings' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'default' => '',
            'selectors' => [
                '{{WRAPPER}} .mylistings' => 'background-color: {{VALUE}}',
            ],
                ]
        );
