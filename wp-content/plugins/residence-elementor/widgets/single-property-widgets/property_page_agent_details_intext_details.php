		...
		$this->start_controls_section(
					 ...
					 $this->add_group_control(
								...
								[
										...
										'selector' => '{{WRAPPER}} .wpestate_estate_property_design_agent_details_intext_details    ,{{WRAPPER}} .wpestate_estate_property_design_intext_details a',
								]
						);
					 ...
					 */
					 ...
					 $this->add_control(
							...
							[
									...
									'default'   => '',
									'selectors' => [
											'{{WRAPPER}} .wpestate_estate_property_design_agent_details_intext_details    ,{{WRAPPER}} .wpestate_estate_property_design_intext_details a'=> 'color: {{VALUE}}',
