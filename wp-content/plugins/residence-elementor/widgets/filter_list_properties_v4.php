...
class Wpresidence_Filter_List_Properties_v4 extends Widget_Base
{
    ...
    {
        return 'Wpresidence_Filter_List_Properties_v4';
    }
    ...
    {
        return __('WpResidence Properties List with Filter V4', 'residence-elementor');
    }
