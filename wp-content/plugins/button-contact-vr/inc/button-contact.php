					...
					<div class="phone-vr">
						...
						<div class="phone-vr-img-circle">
							<a href="<?php echo get_option('pzf_contact_link'); ?>">				
								<img src="<?php echo PZF_URL.'img/contact.png'; ?>" alt="<?php echo $site_title ?>" />
							</a>
						</div>
					</div>
					</div>
					...
					<div class="phone-vr">
						...
						<div class="phone-vr-img-circle">
							<a target="_blank" href="viber://add?number=<?php echo preg_replace( '/\D/', '',get_option('pzf_viber')); ?>">				
								<img src="<?php echo PZF_URL.'img/viber.png'; ?>" alt="<?php echo $site_title ?>" />
							</a>
						</div>
					</div>
					</div>
					...
					<div class="phone-vr">
						...
						<div class="phone-vr-img-circle">
							<a target="_blank" href="https://zalo.me/<?php echo preg_replace( '/\D/', '',get_option('pzf_zalo')); ?>">				
								<img src=" <?php echo PZF_URL.'img/zalo.png'; ?>" alt="<?php echo $site_title ?>" />
							</a>
						</div>
					</div>
					</div>
					...
					<div class="phone-vr">
						...
						<div class="phone-vr-img-circle">
							<a href="tel:<?php echo preg_replace( '/\D/', '',get_option('pzf_phone')); ?>">				
								<img src="<?php echo PZF_URL.'img/phone.png'; ?>" alt="<?php echo $site_title ?>" />
							</a>
						</div>
					</div>
					</div>
			...
			if(get_option('pzf_enable_all_in_one')){ ?>
				<div id="all-in-one-vr" class="button-contact">
					<div class="phone-vr">
						<div class="phone-vr-circle-fill"></div>
						<div class="phone-vr-img-circle">			
							<img src="<?php echo PZF_URL.'img/icon'.get_option('pzf_icon_all_in_one').'.png'; ?>" alt="<?php echo $site_title ?>" />
						</div>
					</div>					
					<?php 
