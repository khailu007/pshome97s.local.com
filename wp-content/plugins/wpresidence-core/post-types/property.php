...
function wpestate_create_property_type() {
    ...
    $rewrites[0] = 'phong-cho-thue';
    register_post_type('estate_property', array(
        'labels' => array(
            'name'                  => esc_html__('Phòng cho thuê','wpresidence-core'),
            'singular_name'         => esc_html__('Danh sách phòng','wpresidence-core'),
            'add_new'               => esc_html__('Thêm mới phòng','wpresidence-core'),
            'add_new_item'          => esc_html__('Phòng mới','wpresidence-core'),
...
////////////////////////////////////////////////////////////////////////////////////////////////
    register_taxonomy('property_category', array('estate_property'), array(
        'labels' => array(
            'name'              => esc_html__('Loại hình','wpresidence-core'),
            'add_new_item'      => esc_html__('Thêm loại hình','wpresidence-core'),
            'new_item_name'     => esc_html__('Loại hình mới','wpresidence-core')
        ),
        'hierarchical'  => true,
        'query_var'     => true,
        'show_in_rest'      => true,
...
register_taxonomy('property_city', array('estate_property'), array(
    'labels' => array(
        'name'              => esc_html__('Phường','wpresidence-core'),
        'add_new_item'      => esc_html__('Thêm phường','wpresidence-core'),
        'new_item_name'     => esc_html__('Phường mới','wpresidence-core')
    ),
    'hierarchical'  => true,
    'query_var'     => true,
    'show_in_rest'      => true,
...
register_taxonomy('property_area', array('estate_property'), array(
    'labels' => array(
        'name'              => esc_html__('Tòa nhà','wpresidence-core'),
        'add_new_item'      => esc_html__('Thêm tòa nhà','wpresidence-core'),
        'new_item_name'     => esc_html__('Tòa nhà mới','wpresidence-core')
    ),
    'hierarchical'  => true,
    'query_var'     => true,
     'show_in_rest'      => true,
...
register_taxonomy('property_county_state', array('estate_property'), array(
    'labels' => array(
        'name'              => esc_html__('Quận','wpresidence-core'),
        'add_new_item'      => esc_html__('Thêm quận','wpresidence-core'),
        'new_item_name'     => esc_html__('Quận mới','wpresidence-core')
    ),
    'hierarchical'  => true,
    'query_var'     => true,
     'show_in_rest'      => true,
...
function wpestate_add_property_metaboxes() {
   // add_meta_box('new_tabbed_interface',         esc_html__('Property Details', 'wpresidence-core'),             'estate_tabbed_interface', 'estate_property', 'normal', 'default' );
    add_meta_box('new_tabbed_interface',         esc_html__('Thông tin phòng cho thuê', 'wpresidence-core'),             'estate_tabbed_interface', 'estate_property', 'normal', 'default' );
}
    ...
    function estate_tabbed_interface(){
        ...
        print'<div class="property_options_wrapper meta-options">
             ...
             <div class="property_options_wrapper_list">
                <div class="property_tab_item active_tab" data-content="property_details">'.esc_html__('Thông tin phòng cho thuê','wpresidence-core').'</div>
                <div class="property_tab_item " data-content="property_media">'.esc_html__('Hình ảnh','wpresidence-core').'</div>
                <div class="property_tab_item" data-content="property_customs">'.esc_html__('Các tiện ích','wpresidence-core').'</div>
                <div class="property_tab_item" data-content="property_map" id="property_map_trigger">'.esc_html__('Địa điểm','wpresidence-core').'</div>

                <div class="property_tab_item we-d-none" data-content="property_energy" id="property_energy_trigger">'.esc_html__('Năng lượng','wpresidence-core').'</div>
                <div class="property_tab_item we-d-none" data-content="property_agent">'.esc_html__('Tư vấn viên','wpresidence-core').'</div>
                <div class="property_tab_item we-d-none" data-content="property_floor">'.esc_html__('Bản vẽ','wpresidence-core').'</div>
                <div class="property_tab_item we-d-none" data-content="property_paid">'.esc_html__('Thanh toán','wpresidence-core').'</div>
                <div class="property_tab_item we-d-none" data-content="property_subunits">'.esc_html__('Thông tin phụ','wpresidence-core').'</div>
            </div>
            <div class="property_options_content_wrapper">
                <div class="property_tab_item_content active_tab" id="property_details"><h3>'.esc_html__('Thông tin phòng cho thuê','wpresidence-core').'</h3>';
                wpestate_estate_box();
                print'</div>

                <div class="property_tab_item_content " id="property_media"><h3>'.esc_html__('Hình ảnh','wpresidence-core').'</h3>';
                wpestate_property_add_media();
                print'</div>

                <div class="property_tab_item_content" id="property_customs"><h3>'.esc_html__('Các tiện ích','wpresidence-core').'</h3>';
                wpestate_custom_details_box();
                print'</div>
                <div class="property_tab_item_content" id="property_map"><h3>'.esc_html__('Địa điểm','wpresidence-core').'</h3>';
                wpestate_map_estate_box();
                print'</div>
                
                <div class="property_tab_item_content we-d-none" id="property_energy"><h3>'.esc_html__('Năng lượng','wpresidence-core').'</h3>';
                wpestate_energy_box();
                print'</div>';
                    

                print'<div class="property_tab_item_content we-d-none" id="property_agent"><h3>'.esc_html__('Tư vấn viên','wpresidence-core').'</h3>';
                wpestate_agentestate_box();
                print'</div>
                <div class="property_tab_item_content we-d-none" id="property_floor"><h3>'.esc_html__('Bản vẽ','wpresidence-core').'</h3>';
                wpestate_floorplan_box();
                print'</div>
                <div class="property_tab_item_content we-d-none" id="property_paid"><h3>'.esc_html__('Thanh toán','wpresidence-core').'</h3>';
                wpestate_estate_paid_submission();
                print'</div>
                <div class="property_tab_item_content we-d-none" id="property_subunits"><h3>'.esc_html__('Thông tin phụ','wpresidence-core').'</h3>';
...
function wpestate_map_estate_box() {
    ...
    <div class="property_prop">
        <label for="property_address">'.esc_html__('Địa chỉ phòng cho thuê: ','wpresidence-core').'</label><br />
        <label style="color: #cf2e2e;">'.esc_html__('Example: 183/41 Nguyễn Hữu Cảnh, Bình Thạnh, Thành phố Hồ Chí Minh','wpresidence-core').'</label><br />
    ...
    <div class="property_prop_half we-d-none">
    ...
    <div class="property_prop_half">
        <label for="property_latitude">'.esc_html__('Vĩ độ:','wpresidence-core').'</label> <br />
        <label style="color: #cf2e2e;">'.esc_html__('Example: 10.797554875621','wpresidence-core').'</label> <br />
        <input type="text" id="property_latitude" style="margin-right:20px;" size="40" name="property_latitude" value="' . $gmap_lat . '">
    </div>

    <div class="property_prop_half">
        <label for="property_longitude">'.esc_html__('Kinh độ:','wpresidence-core').'</label> <br />
        <label style="color: #cf2e2e;">'.esc_html__('Example: 106.71968841113','wpresidence-core').'</label> <br />
        <input type="text" id="property_longitude" style="margin-right:20px;" size="40" name="property_longitude" value="' . $gmap_long . '">
    </div>

   <div class="property_prop_half">
       <label for="page_custom_zoom">'.esc_html__('Mức độ thu phóng','wpresidence-core').'</label><br />
    ...
    <div class="property_prop_half we-d-none">
        ...
        if(empty($google_camera_angle)):
        	$google_camera_angle = '100';
    	endif;
        print '<input type="text" id="google_camera_angle" style="margin-right:0px;" size="5" name="google_camera_angle" value="'.$google_camera_angle.'">
    </div>


    <div class="property_prop_half we-d-none" style="padding-top:20px;">
...
print '<button class="upload_button button" id="button_new_image" data-postid="'.$post->ID.'">'.esc_html__('Tải hình ảnh','wpresidence-core').'</button>';
    ...
    print'
    <div class="property_prop_half we-d-none" style="clear: both;">
    ...
    print'<div class="property_prop_half prop_full we-d-none">
...
function wpestate_estate_box() {
    ...
    print'
    <div class="property_prop_half">
        <label for="property_price">'.esc_html__('Giá thuê: ','wpresidence-core').'</label><br />
    ...
    <div class="property_prop_half we-d-none">
        ...
        <input type="text" id="property_second_price" size="40" name="property_second_price" value="' . esc_html(get_post_meta($mypost, 'property_second_price', true)) . '">
    </div>
    ...
    <div class="property_prop_half">
        <label for="property_size">'.esc_html__('Diện tích phòng: ','wpresidence-core').'</label><br />
    ...
    <div class="property_prop_half prop_half we-d-none">
...
function wpestate_country_list($selected,$class='') {
    ...
    foreach ($countries as $country) {
        if($country == 'Vietnam'): // Mặc định là Việt Nam thì chạy vào vòng lặp
...
function we_unregister_for_estate_property() {
    unregister_taxonomy_for_object_type( 'property_action_category', 'estate_property' );
    unregister_taxonomy_for_object_type( 'property_status', 'estate_property' );
    unregister_taxonomy_for_object_type( 'property_features', 'estate_property' ); 
}
add_action( 'init', 'we_unregister_for_estate_property' );
