...
unregister_post_type( 'wpestate_invoice' );
}
...
function wpestate_ajax_create_print_invoice(){
	...
	print '<div class="wpestate_print_invoice_details_wrapper">';
		print '<div class="wpestate_print_invoice_details_detail"><label>'.esc_html__('Billing for','wpresidence-core').': </label>'.$invoice_saved. '</div>';
		print '<div class="wpestate_print_invoice_details_detail"><label>'.esc_html__('Billing type','wpresidence-core').': </label>'.$invoice_period_saved.'</div>';
