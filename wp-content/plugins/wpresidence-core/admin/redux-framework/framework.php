            ...
            public static function init() {
                ...
                if ( self::$_is_plugin == true || self::$_as_plugin == true ) {
                    ...
                    if (strpos(self::$_url,'bitnami' ) !== false) {
                        self::$_url = '/wp-content/plugins/wpresidence-core/admin/redux-framework/';
                    }
                } else {
                ...
                if ( $menu ) {
                    ...
                    if ( isset ( $submenu[ $this->args["page_slug"] ] ) && is_array( $submenu[ $this->args["page_slug"] ] ) ) {
                        foreach ( $submenu[ $this->args["page_slug"] ] as $index => $redux_options_submenu ) {
                            ...
                            $link_x =  admin_url( 'admin.php?page=' . $redux_options_submenu[2] );
                            
                            if( strpos($redux_options_submenu[2] , 'wp-admin/plugins.php') !== false){
                                $link_x = $redux_options_submenu[2] ;
                            }
