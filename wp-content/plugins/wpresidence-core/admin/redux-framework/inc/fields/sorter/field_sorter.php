                ...
                if ( is_array( $sortlists ) ) {
                    ...
                    if ( $sortlists ) {
                        ...
                        foreach ( $sortlists as $group => $sortlist ) {
                            ...
                            echo '<h3>';
                            if($group=='enabled'){ 
                                esc_html_e('Visible','Wpresidence-core');
                             }else{
                                 esc_html_e('Disabled','Wpresidence-core');
                             }
                            ...
                            foreach ( $sortlist as $key => $list ) {
                                ...
                                if ( $key != "placebo" ) {
                                    ...
                                    echo '<input class="position ' . esc_attr($this->field['class']) . '" type="hidden" name="' . esc_attr($this->field['name'] . '[' . $group . '][' . $key . ']' . $this->field['name_suffix']) . '" value="';
