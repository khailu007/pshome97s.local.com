<?php
    ...
    define ('WPESTATE_ADMIN_IMAGE_PATH','xxx');
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
                ...
                'subtitle' => __( 'Select the measurement unit you will use on the website for Properties Size & Lot Size fields.', 'wpresidence-core' ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            array(
                ...
                'type'     => 'button_set',
                'title'    => __( 'Display user types dropdown in register forms', 'wpresidence-core' ),
            ...
            array(
                ...
                'title'    => __( 'Select user types to display in register forms.', 'wpresidence-core' ),
              ...
              array(
                ...
                'class'    => 'class_visible_user_role',
                'required' => array('wp_estate_visible_user_role_dropdown', '=', 'yes'),
                'title'    => __( 'Select wich user role admin should approve manually', 'wpresidence-core' ),
                'subtitle' => __( 'The other users will be automatically approved. *Hold CTRL for multiple selection.', 'wpresidence-core' ),
                'options'  => array(
  ...
  Redux::setSection( $opt_name, array(
    ...
    'fields'     => array(
            ...
            array(
                    ...
                    'type'     => 'text',
                    'title'    => __( 'Properties number per page in property list pages', 'wpresidence-core' ),
                    'subtitle' => __( 'Set how many properties to show per page.', 'wpresidence-core' ),
                    'default'  => '12'
            ),
           array(
            ...
            array(
                ...
                'type'     => 'button_set',
                'title'    => __( 'Property list layout type for taxonomy pages', 'wpresidence-core' ),
                'subtitle' => __( 'Select between standard or half map style for property taxonomies pages.', 'wpresidence-core' ),
                'options'  => array(
            ...
            array(
                ...
                'type'     => 'button_set',
                'title'    => __( 'Properties default order in taxonomy pages', 'wpresidence-core' ),
                'subtitle' => __( 'Select the default order for properties in taxonomy pages', 'wpresidence-core' ),
            ...
            array(
                ...
                'subtitle' => __( 'Select the map position for all pages with half map layout enabled.', 'wpresidence-core' ),
                'options'  => array(
            ...
            array(
                ...
                'subtitle' => __( 'Where to show the sidebar on the agent page.', 'wpresidence-core' ),
                'options'  => array(
            ...
            array(
                ...
                'subtitle' => __( 'Which sidebar to show in agent page? Create new Sidebars from Appearance -≥ Sidebars.', 'wpresidence-core' ),
                'data'  =>  'sidebars',
            ...
            array(
                ...
                'type'     => 'button_set',
                'title'    => __( 'Property Taxonomy and Blog Category/Archive - Select Sidebar Position', 'wpresidence-core' ),
            ...
            array(
                ...
                'type'     =>   'select',
                'title'    =>   __( 'Property Taxonomy and Blog Category/Archive - Select the Sidebar', 'wpresidence-core' ),
            ...
            array(
                ...
                'type'     => 'button_set',
                'title'    => __( 'Blog Category/Archive - List Layout Type', 'wpresidence-core' ),
                'subtitle' => __( 'Select between list or grid layouts for Blog Category/Archive list.', 'wpresidence-core' ),
                'options'  => array(
    ...
    Redux::setSection($opt_name, array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'subtitle' => __( 'Enable or disable top bar widgets on mobile devices', 'wpresidence-core' ),
                'options'  => array(
                    'yes' => 'yes',
                    'no'  => 'no'
                    ),
            ...
            array(
                    ...
                    'type'     => 'text',
                    'title'    => __( 'Header Phone Number. Leave blank to show none', 'wpresidence-core' ),
            ...
            array(
                ...
                'type'     => 'button_set',
                'title'    => __( 'Header Design Type?', 'wpresidence-core' ),
            ...
            array(
                ...
                'subtitle' => __( 'Select logo position. Please note that there is no "center" align for type 1, 5 and 6.', 'wpresidence-core' ),
                'options'  => array(
                    'left'   => 'left',
                    'center' => 'center',
                    'right'  => 'right'
            ...
            array(
                ...
                'title'    => __( 'Main menu alignnment for Header Type 1?', 'wpresidence-core' ),
                'subtitle' => __( 'Select menu align position for Header Type 1.', 'wpresidence-core' ),
                'options'  => array(
                    'left'   => 'left',
                    'center' => 'center',
                    'right'  => 'right'
            ...
            array(
                ...
                'type'     => 'button_set',
                'title'    => __( 'Header type 3&4 text alignment?', 'wpresidence-core' ),
                'subtitle' => __( 'Select text alignment for header types 3 and 4.', 'wpresidence-core' ),
                'options'  => array(
                    'left'   => 'left',
                    'center' => 'center',
                    'right'  => 'right'
            ...
            array(
                    ...
                    'title'    => __( 'Media Header - Revolution Slider', 'wpresidence-core' ),
            ...
            array(
                ...
                'title'    => __( 'Media Header - Static Image', 'wpresidence-core' ),
            ...
            array(
                ...
                'type'     => 'button_set',
                'title'    => __( 'Media Header Type for taxonomy pages?', 'wpresidence-core' ),
                'subtitle' => __( 'Media Header is the first section below header. Select what media header to use globally for taxonomies/categories. Map is mandatory for Half Map layout.', 'wpresidence-core' ),
                'options'  => array(
                    'none',
                    'image',
                    'theme slider',
            ...
            array(
                ...
                'type'     => 'button_set',
                'title'    => __( 'Media Header Type for Blog Posts?', 'wpresidence-core' ),
            ...
            array(
                    ...
                    'title'    => __( 'Blog Post Header -  Revolution Slider', 'wpresidence-core' ),
                    'subtitle' => __( 'If media header is set to Revolution Slider, type the slider name and save.', 'wpresidence-core' ),
            ),
            ...
            array(
                ...
                'title'    => __( 'Blog Post Header Static Image', 'wpresidence-core' ),
            ...
            array(
                    ...
                    'type'     => 'text',
                    'title'    => __( 'Header 5 - Info widget 1 - icon', 'wpresidence-core' ),
                    'subtitle' => __( 'Header 5 - Info widget 1 - icon. Ex: fa fa-phone', 'wpresidence-core' ),
            ),
            ...
            array(
                    ...
                    'type'     => 'text',
                    'required'  => array('wp_estate_logo_header_type','=','type5'),
                    'title'    => __( 'Header 5 - Info widget 1 - First line of text', 'wpresidence-core' ),
                    'subtitle' => __( 'Header 5 - Info widget 1 - First line of text', 'wpresidence-core' ),
            ),
            ...
            array(
                    ...
                    'type'     => 'text',
                    'required'  => array('wp_estate_logo_header_type','=','type5'),
                    'title'    => __( 'Header 5 - Info widget 1 - Second line of text', 'wpresidence-core' ),
                    'subtitle' => __( 'Header 5 - Info widget 1 - Second line of text', 'wpresidence-core' ),
            ),
            ...
            array(
                    ...
                    'type'     => 'text',
                    'required'  => array('wp_estate_logo_header_type','=','type5'),
                    'title'    => __( 'Header 5 - Info widget 2 - icon', 'wpresidence-core' ),
                    'subtitle' => __( 'Header 5 - Info widget 2 - icon. Ex: fa fa-phone', 'wpresidence-core' ),
            ),
            ...
            array(
                ...
                'subtitle' => __( 'Enable parallax efect for image/video media header globally.', 'wpresidence-core' ),
                'options'  => array(
                    'yes'  => 'yes',
                    'no'   => 'no',
                    ),
            ...
            array(
                ...
                'subtitle' => __( 'Use Sticky mobile header', 'wpresidence-core' ),
                'options'  => array(
                    'yes'  => 'yes',
                    'no'   => 'no',
                    ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
           ...
           array(
                ...
                'subtitle' => __( 'Use file reading for pins? (*recommended for over 200 listings. Read the manual for differences between file and mysql reading)', 'wpresidence-core' ),
                'options'  => array(
                            'yes' => 'yes',
                            'no'  => 'no'
                            ),
...
//            ),
            ...
            array(
                ...
                'type'     => 'text',
                'title'    => __( 'MapBox API KEY -  used for tile (maps images) serveronly', 'wpresidence-core' ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
                ...
                'subtitle' => __( 'Media Header is the first section below header. The option you select will be visible on all property pages.', 'wpresidence-core' ),
                'options'  => array(
                    'none',
                    'image',
                    'theme slider',
            ...
            array(
                ...
                'title'    => __( 'Property Media Header -  Revolution Slider', 'wpresidence-core' ),
                'subtitle' => __( 'If media header is set to Revolution Slider, type the slider name and save.', 'wpresidence-core' ),
            ),
            ...
            array(
                ...
                'title'    => __( 'Property Media Header - Static Image', 'wpresidence-core' ),
                'subtitle' => __( 'If media header is set to image, and no image is added we will use the taxonomy featured image', 'wpresidence-core' ),
            ),
            ...
            array(
                ...
                'type'     => 'button_set',
                'title'    => __( '"Media Section" Type (images & video) ', 'wpresidence-core' ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
                ...
                'subtitle' => __( 'No of Search fields. Save and refres to see the fields.', 'wpresidence-core' ),
                'default'  => '8'
            ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
                ...
                'type'     => 'color',
                'title'    => __( 'Advanced Search Fields Tab Font Color', 'wpresidence-core' ),
                'subtitle' => __( 'Advanced Search Fields Tab Font Color. Applies for non active tabs with Search type 6 and 8.', 'wpresidence-core' ),
                'transparent'  => false,
            ),
             array(
                'id'       => 'wp_estate_adv_search_tab_back_font_color',
                'type'     => 'color',
                'title'    => __( 'Advanced Search Fields Tab Background Color', 'wpresidence-core' ),
                'subtitle' => __( 'Advanced Search Fields Tab Background Color. Applies for non active tabs with Search type 6 and 8.', 'wpresidence-core' ),
                'transparent'  => false,
            ),
