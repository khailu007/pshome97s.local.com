                ...
                <div class="col-md-8 agency_content">
                    ...
                    <div class="agency_socialpage_wrapper">
                        <?php
                            ...
                            if($agency_facebook!=''){
                                print ' <a class="agency_social" href="'.esc_url($agency_facebook).'" target="_blank" rel="noopener" ><i class="fab fa-facebook-f"></i></a>';
                            }
                            if($agency_twitter!=''){
                                print ' <a class="agency_social" href="'.esc_url($agency_twitter).'" target="_blank" rel="noopener" ><i class="fab fa-twitter"></i></a>';
                            }
                            if($agency_linkedin!=''){
                                print ' <a class="agency_social" href="'.esc_url($agency_linkedin).'" target="_blank" rel="noopener" ><i class="fab fa-linkedin-in"></i></a>';
                            }
                            if($agency_pinterest!=''){
                                print ' <a class="agency_social" href="'.esc_url( $agency_pinterest).'" target="_blank" rel="noopener" ><i class="fab fa-pinterest-p"></i></a>';
                            }
                            if($agency_instagram!=''){
                                print ' <a class="agency_social" href="'. esc_url($agency_instagram).'" target="_blank" rel="noopener" ><i class="fab fa-instagram"></i></a>';
                            }
