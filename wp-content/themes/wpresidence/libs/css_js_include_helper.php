    ...
    function wpestate_load_google_map($force_places='no'){
        ...
        if($what_map==1){
            ...
            if (!wp_script_is( 'googlemap', 'enqueued' )) {
                ...
                //    wp_enqueue_script('googlemapplaces', 'https://maps.googleapis.com/maps/api/js?key='.esc_html(wpresidence_get_option('wp_estate_api_key', '') .'&amp;libraries=places'),array('jquery'), '1.0', true);
