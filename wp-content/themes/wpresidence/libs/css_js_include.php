...
function wpestate_scripts() {
    ...
    // load the css files
    /////////////////////////////////////////////////////////////////////////////////////////////////////////
    wp_enqueue_style('zalo-me-qr',get_theme_file_uri('/css/zalo-me-qr.css'), array(), $theme_object->Version, 'all');
    ...
    //wp_enqueue_style('wpestate_wip',get_theme_file_uri('/css/wip.css'), array(), $theme_object->Version, 'all');
    ...
    if($general_font && $general_font!='x'){
       ...
       // wp_enqueue_style( 'wpestate-nunito', "https://fonts.googleapis.com/css?family=Nunito+Sans:300,400,600,700,800,900&amp;subset=latin,latin-ext" );
        wp_enqueue_style( 'wpestate-roboto', "https://fonts.googleapis.com/css?family=Roboto:wght@300,400,500,700&amp;subset=latin,latin-ext" );
    ...
    wp_enqueue_style( 'font-awesome-6.min',  get_theme_file_uri( '/css/vendors/fontawesome/v6/dist/css/fontawesome.min.css') );
    wp_enqueue_style( 'font-awesome-6-regular.min',  get_theme_file_uri( '/css/vendors/fontawesome/v6/dist/css/regular.min.css') );
    wp_enqueue_style( 'font-awesome-6-solid.min',  get_theme_file_uri( '/css/vendors/fontawesome/v6/dist/css/solid.min.css') );
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////
    wp_enqueue_script('we-js.we-frontend.min', get_template_directory_uri().'/js/we-js/we-frontend.min.js',array(), $theme_object->Version, true);
...
function wpestate_admin($hook_suffix) {
    ...
    if (is_admin() &&  ( $pagenow=='post-new.php' || $pagenow=='post.php') && ($typenow=='estate_property' || $typenow=='estate_agency' || $typenow=='estate_developer') ) {
        ...
        if($what_map==1){
            if ( is_ssl() ){
                wp_enqueue_script('googlemap',      'https://maps-api-ssl.google.com/maps/api/js?v=quarterly'.$libraries.'&key='.esc_html(wpresidence_get_option('wp_estate_api_key', '') ).'',array('jquery'), $theme_object->Version, false);
           
            }else{
                wp_enqueue_script('googlemap',      'http://maps.googleapis.com/maps/api/js?v=quarterly'.$libraries.'&key='.esc_html(wpresidence_get_option('wp_estate_api_key', '') ).'',array('jquery'), $theme_object->Version, false);
            }
