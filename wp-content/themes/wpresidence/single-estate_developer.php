    ...
    <div class=" <?php print esc_html($wpestate_options['content_class']);?> ">
        ...
        while (have_posts()) : the_post(); 
            ...
            if(isset($preview[0])){
                ...
                $preview_img  = get_theme_file_uri('/img/defaults/default_user_agent.gif');
            }
        ...
        <div class="single-content single-agent">    
            ...
            <?php  include( locate_template('templates/developer_templates/developer_listings.php') );  ?>
            ...
            if(is_array($wp_estate_show_reviews) && in_array('developer', $wp_estate_show_reviews)){
                include( locate_template('templates/developer_templates/developer_reviews.php'));  
            }
            ?>
            </div> 
        </div>  
