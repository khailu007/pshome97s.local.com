                                    ...
                                    foreach($attchs as $att_id){
                                        if( $att_id!='' && is_numeric($att_id) ){
                                            ...
                                            if($preview[0]!=''){
                                                ...
                                                $images .=  '<div class="uploaded_images" data-imageid="'.esc_attr($att_id).'"><img src="'.get_theme_file_uri('/img/pdf.png').'" alt="'.esc_html__('user document','wpresidence').'" /><i class="far fa-trash-alt"></i>';
