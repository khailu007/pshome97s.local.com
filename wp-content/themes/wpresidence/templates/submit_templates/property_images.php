                                    ...
                                    foreach($attchs as $att_id){
                                        if( $att_id!='' && is_numeric($att_id) ){
                                            ...
                                            if(isset($preview[0]) && $preview[0]!=''){
                                                ...
                                                $images .= '<i class="fas fa-font image_caption_button"></i><div class="image_caption_wrapper"><input data-imageid="'.esc_attr($att_id).'" type="text" class="image_caption form_control" name="image_caption" value="'.esc_attr(wp_get_attachment_caption($att_id)).'"></div>';
                                                if($thumbid==$att_id){
