                    ...
                    ?>
                        ...
                        <div class="login_sidebar">
                            ...
                            <div class="login_form" id="login-div_mobile">
                                ...
                                <input type="text" class="form-control" name="log" id="login_user_mobile" autofocus placeholder="<?php esc_html_e('Username','wpresidence');?>"/>
                                <div class="password_holder"><input type="password" class="form-control" name="pwd" id="login_pwd_mobile" placeholder="<?php esc_html_e('Password','wpresidence');?>"/>
                            ...
                            <div class="login_form" id="register-div-mobile">
                                ...
                                <input type="text" name="user_login_register" id="user_login_register_mobile" class="form-control" autofocus  placeholder="<?php esc_html_e('Username','wpresidence');?>"/>
                                <input type="email" name="user_email_register" id="user_email_register_mobile" class="form-control" placeholder="<?php esc_html_e('Email','wpresidence');?>"  />

                                <?php
                                $enable_user_pass_status= esc_html ( wpresidence_get_option('wp_estate_enable_user_pass','') );
                                if($enable_user_pass_status == 'yes'){
                                    print '<div class="password_holder"><input type="password" name="user_password" id="user_password_mobile" class="form-control" placeholder="'.esc_html__('Password','wpresidence').'"/> <i class=" far fa-eye-slash show_hide_password"></i>
                        </div>
                                    <div class="password_holder"><input type="password" name="user_password_retype" id="user_password_mobile_retype" class="form-control" placeholder="'.esc_html__('Retype Password','wpresidence').'"  /> <i class=" far fa-eye-slash show_hide_password"></i>
                        </div>
                                    ';
                                }
                                ?>
                                        ...
                                        if(is_array($permited_roles)){
                                            foreach($user_types as $key=>$name){
                                                if(in_array($name, $permited_roles)){
                                                    print '<option value="'.esc_attr($key+1).'">'.esc_html($name).'</option>';
                                                }
                                            }
                                        }
                                        print '</select>';
                            ...
                            <div class="login_form" id="forgot-pass-div-mobile">
                                ...
                                <div class="loginrow">
                                    <input type="email" class="form-control" name="forgot_email" id="forgot_email_mobile" autofocus placeholder="<?php esc_html_e('Enter Your Email Address','wpresidence');?>" size="20" />
                                </div>
