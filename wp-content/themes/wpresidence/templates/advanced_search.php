...
if($show_adv_search!=='no'){
    ...
    $use_float_search_form      =   wpestate_retrive_float_search_placement( $post_id);
    ...
    ( $current_page_template== 'contact_page.php') || is_singular('estate_agency') || is_singular('estate_developer') )
    ...
    <div class="search_wrapper search_wr_<?php print esc_attr($adv_search_type.' '. $page_without_search.' '.$close_class_wr.' '.$search_start_class);?>" id="search_wrapper"  <?php print wpestate_search_float_position($post_id);?>data-postid="<?php echo intval($post_id); ?>">

    <?php


        if (  (isset($post->ID) && is_page($post->ID) &&  
                (   $current_page_template== 'contact_page.php') || 
            ...
            if ($adv_search_type==1){
                ...
                include(get_theme_file_path('templates/advanced_search/advanced_search_type3.php'));
            }else if ($adv_search_type==4){
                include(get_theme_file_path('templates/advanced_search/advanced_search_type4.php'));
            }else if ($adv_search_type==5){
                include(get_theme_file_path('templates/advanced_search/advanced_search_type5.php'));
            }else if ($adv_search_type==6){
                include(get_theme_file_path('templates/advanced_search/advanced_search_type6.php'));
            }else if ($adv_search_type==7){
                include(get_theme_file_path('templates/advanced_search/advanced_search_type7.php'));
            } else if ($adv_search_type==8){
                include(get_theme_file_path('templates/advanced_search/advanced_search_type8.php'));
            } else if ($adv_search_type==9){
                include(get_theme_file_path('templates/advanced_search/advanced_search_type9.php'));
            }else if ($adv_search_type==10){
                include(locate_template('templates/advanced_search/advanced_search_type10.php'));
            }else if ($adv_search_type==11){
                include(get_theme_file_path('templates/advanced_search/advanced_search_type11.php'));
            }else{

                if( !is_tax() && $current_page_template !== 'advanced_search_results.php'){
                    include(get_theme_file_path('templates/advanced_search/advanced_search_type2.php'));
                }else{
