...
// Begin Duy Khai Change label Filter Page Property
   ...
   // county / state fielter
    ...
    if(isset($current_adv_filter_county[0])){
        if($current_adv_filter_county[0]=='all'){
            $current_adv_filter_county_label      =esc_html__('Quận','wpresidence');
            $current_adv_filter_county_meta       = 'Quận';
        }else{
    ...
    if($current_adv_filter_area[0]=='all'){
        $current_adv_filter_area_label      =esc_html__('Tòa nhà','wpresidence');
        $current_adv_filter_area_meta       = 'Tòa nhà';
    }else{
    ...
    if($current_adv_filter_city[0]=='all'){
        $current_adv_filter_city_label      =esc_html__('Phường','wpresidence');
        $current_adv_filter_city_meta       = 'Phường';
    }else{
...
// End Duy Khai Change label Filter Page Property
