...
<?php }else if(is_singular('estate_property')){
     ...
     if(!isset($realtor_details['realtor_mobile']))$realtor_details['realtor_mobile']='';
     $whatsup_mess='https://api.whatsapp.com/send?phone='.esc_html($realtor_details['realtor_mobile']).'&text='.esc_html__('Hello I\'m interested in ','wpresidence').'['.get_the_title($propid).'] '.get_permalink($propid);
