            ...
            <div class=" contact_page_company_details">
                <div class="company_headline ">   
                    ...
                    <div class="header_social">
                        <?php
                        if($facebook_link!=''){
                            print ' <a href="'.esc_url($facebook_link).'" rel="noopener"  ><i class="fab fa-facebook-f"></i></a>';
                        }

                        if($twitter_link!=''){
                           print ' <a href="'.esc_url($twitter_link).'" rel="noopener"  ><i class="fab fa-twitter"></i></a>';
                        }
                        
                        if($google_link!=''){
                            print ' <a href="'.esc_url($google_link).'" rel="noopener" ><i class="fab fa-google-plus-g"></i></a>';
                        }

                        if($linkedin_link!=''){
                            print ' <a href="'.esc_url($linkedin_link).'" rel="noopener" ><i class="fab fa-linkedin-in"></i></a>';
                        }

                        if($pinterest_link!=''){
                             print ' <a href="'.esc_url($pinterest_link).'" rel="noopener" ><i class="fab fa-pinterest-p"></i></a>';
                        }
                        if($instagram_link!=''){
                             print ' <a href="'.esc_url($instagram_link).'" rel="noopener" ><i class="fab fa-instagram"></i></a>';
                        }
